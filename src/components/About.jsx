...
const About = () => {
  return (
    <section id="about" className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(212,175,55,0.14),_transparent_25%),radial-gradient(circle_at_bottom_right,_rgba(96,165,250,0.12),_transparent_30%),#0f172a] text-white px-6">
