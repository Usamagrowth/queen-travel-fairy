...
const Hero = () => {
  ...
  return (
   <section id="home" className="max-w-7xl mx-auto  py-2 w-full">
        {/* Slideshow */}
        <div className="relative h-[500px] md:h-[600px] rounded-2xl overflow-hidden">
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                ...
                <motion.p
                  ...
                  className="text-slate-300 text-lg md:text-xl font-sans leading-relaxed max-w-lg mb-6"
                >
                  {slide.subtitle}
                </motion.p>
              </div>
         ...
         <a href="#booking" className="absolute bottom-1 left-8 inline-flex items-center gap-3 px-3 py-2 bg-gradient-to-r from-[#FFD966] via-[#F2C94C] to-[#D4AF37] text-slate-950 font-semibold rounded-full uppercase tracking-[0.22em] text-sm shadow-[0_24px_60px_rgba(212,175,55,0.35)] transition-transform duration-300 hover:-translate-y-1 hover:shadow-[0_28px_72px_rgba(212,175,55,0.45)] z-20">
            Begin Your Journey
          </a>
           {/* Slide indicators */}
            ...
            {slides.map((_, idx) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-all ${
                  slideIndex === idx ? "bg-[#D4AF37]  w-3" : "bg-white/40 hover:bg-white/60"
                }`}
              />
            ))}
          </div>
